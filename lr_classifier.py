# USAGE
# python logistic_regression_classifier.py --dataset database
...
print("[INFO] evaluating LogisticRegression accuracy...")
lr = LogisticRegression(C=1.0, random_state=0)

lr.fit(trainFeat, trainLabels)
acc = lr.score(testFeat, testLabels)
print("[INFO] LogisticRegression accuracy: {:.2f}%".format(acc * 100))
