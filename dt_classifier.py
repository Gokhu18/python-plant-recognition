# USAGE
# python dt_classifier.py --dataset database
...
# train and evaluate a Deicion Tree classifer on the contour ffts
print("[INFO] evaluating DecisionTreeClassifier accuracy...")
dt = DecisionTreeClassifier()

dt.fit(trainFeat, trainLabels)
acc = dt.score(testFeat, testLabels)
print("[INFO] DecisionTreeClassifier accuracy: {:.2f}%".format(acc * 100))
